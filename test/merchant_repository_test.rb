...
class MerchantRepositoryTest < Minitest::Test
  ...
  def setup
    ...
    @test_merchant_repository = MerchantRepository.new(contents, parent)
  end
  ...
  def test_initialization_populates_the_repository
    ...
    actual_merchant_1 = test_merchant_repository.find_by_id(merchant_1_id)
    actual_merchant_2 = test_merchant_repository.find_by_id(merchant_2_id)
    actual_merchant_3 = test_merchant_repository.find_by_id(merchant_3_id)
    ...
    assert_equal 3, test_merchant_repository.count
  ...
  def test_it_can_find_all_by_name
    ...
    actual_merchants_w_name_1 = test_merchant_repository.find_all_by_name(name_1)
    actual_merchants_w_name_2 = test_merchant_repository.find_all_by_name(name_2)
    actual_merchants_w_name_3 = test_merchant_repository.find_all_by_name(name_3)
  ...
  def test_it_finds_items_by_merchant_id
    ...
    actual_items_1 = test_merchant_repository.find_items_by_merchant(12334141)
    actual_items_2 = test_merchant_repository.find_items_by_merchant(11111111)
